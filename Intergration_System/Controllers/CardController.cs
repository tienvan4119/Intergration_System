...
namespace TM.API.Controllers
{
    ...
    public class CardController : BaseController
    {
        ...
        {
            return await _service.Add(request, CreateAddCardHistoryRequest(HistoryActionType.Added));
        }
        ...
        {
            return await _service.AssignCard(request, CreateAddCardHistoryRequest(HistoryActionType.Assign));
        ...
        {
            return await _service.AddTag(request,
