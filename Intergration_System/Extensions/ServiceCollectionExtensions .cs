...
namespace TaskManager.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDatabaseContext(this IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IDbFactory), typeof(DbFactory<TaskManagerContext>))
                .AddScoped(typeof(IDbFactory<>), typeof(DbFactory<>))
                .AddScoped(typeof(IUnitOfWorkBase<>), typeof(UnitOfWorkBase<>))
                .AddScoped(typeof(IUnitOfWorkBase), typeof(UnitOfWorkBase<TaskManagerContext>));
